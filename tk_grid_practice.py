...
# tk 레이블 추가
label1 = tk.Label(win, text="입력 필드에 값을 입력하고 확인 버튼을 누르면 입력한 값을 반영하는 창 만들기")
label1.grid(column=0, row=0)

label2 = tk.Label(win, text="아무 값을 입력하시오.")
label2.grid(column=0, row=1)

label3 = tk.Label(win, text="결과 값 :")
...
button = tk.Button(win, text="확인", command=update_label, width=5)
button.grid(column=2, row=1)

# tk 버튼 추가
button2 = tk.Button(win, text="닫기", command=win.quit)
